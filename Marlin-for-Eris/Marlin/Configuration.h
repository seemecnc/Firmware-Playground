...
#define DEFAULT_MAX_ACCELERATION      {1400,1400,1400,3500}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
