...
#define STRING_VERSION_CONFIG_H __DATE__ "11042014" __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "Johnoly99" // Who made the changes.
...
#define X_MAX_LENGTH 150 //(X_MAX_POS - X_MIN_POS)
#define Y_MAX_LENGTH 150 //(Y_MAX_POS - Y_MIN_POS)
#define Z_MAX_LENGTH MANUAL_Z_HOME_POS  //(Z_MAX_POS - Z_MIN_POS)
//============================= Bed Auto Leveling ===========================
...
#define MANUAL_Z_HOME_POS 243.2
...
#define DEFAULT_MAX_FEEDRATE          {250, 250, 250, 110}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1200,1200,1200,6500}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
...
#define DEFAULT_EJERK                 27.0    // (mm/sec)
