...
#define STRING_VERSION_CONFIG_H __DATE__ " V1.3 " __TIME__ // build date and time
...
#define MANUAL_Z_HOME_POS 240.7 // For delta: Distance between nozzle and print surface after homing.
