...
#elif MOTHERBOARD==302  // MINI RAMBO uses a different way to handle the motor current than the digipot on the full RAMBO boards
#define DEFAULT_PWM_MOTOR_CURRENT  {1300, 1300, 1250} // MINI RAMBO current values are 0 - 2000 format is (XY,Z,E)
#endif
