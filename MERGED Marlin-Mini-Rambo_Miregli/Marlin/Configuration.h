...
#define STRING_VERSION_CONFIG_H __DATE__ "JULY2014" __TIME__ // build date and time
...
#define DELTA_DIAGONAL_ROD 178.0 // mm     // ORION arms are 178.0, Rostock MAX arms are 269.0
...
#define MANUAL_Z_HOME_POS 240.3 // For delta: Distance between nozzle and print surface after homing.
...
#define DEFAULT_XYJERK                32.5    // (mm/sec)
#define DEFAULT_ZJERK                 32.5    // (mm/sec) Must be same as XY for delta
...
#if defined MIREGLI  //removed () around MIREGLI???
  #define DOGLCD
  #define SDSUPPORT
  #define ULTRA_LCD
  #define ULTIPANEL
