...
int coolingPin = 6;  //added this pin to get turned on ALL the time for cooling drivers and the barrel cooler on the hotend

void setup()
{
    pinMode(coolingPin, OUTPUT);  // set this cooler pin as an output
    Printer::setup();
...
void loop()
{
    digitalWrite(coolingPin, HIGH);  // turn this cooling pin ON when powered up
