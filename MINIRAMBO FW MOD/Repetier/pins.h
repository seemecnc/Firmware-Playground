...
// #define KNOWN_BOARD
/*****************************************************************
* RAMBo and new MINI-RAMBO Pin Assignments
******************************************************************/
...
// #define HEATER_BED_PIN 3   commented out as its now an if below
#define TEMP_BED_PIN   2

// #define HEATER_0_PIN   9   commented out as its an if below
#define TEMP_0_PIN     0
...
// adding below set of defines for new mini rambo
...
#define HEATER_0_PIN  9  // added for mini rambo update
#define HEATER_BED_PIN 3  // added for mini rambo update
#define PS_ON_PIN          -1 // added for mini rambo update
